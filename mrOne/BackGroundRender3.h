...
void Change_bgLv01(){
	...
	//new codes//newcodes//newcodes//newcodes//
...
void Change_bgLv02Upper(){
	for(int i = 0; i < 20; i++){
		if(bgMove02){
			BgLv02Upper[i].x -= 3;
			if(BgLv02Upper[i].x <= 0){
              BgLv02Upper[i].x = 1280;
			}
		}
	}
}
...
void Change_bgLv03Upper(){
	for(int i = 0; i < 20; i++){
		if(bgMove03){
			BgLv03Upper[i].x -= 3;
			if(BgLv03Upper[i].x <= 0){
